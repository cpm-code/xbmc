...
function(copy_skin_to_buildtree skin)
  ...
  get_filename_component(skin_name ${skin} NAME)

  if(skin_name STREQUAL "skin.cpm.estuary" AND EXISTS ${skin}/media/Textures.xbt)
    copy_file_to_buildtree(${skin}/media/Textures.xbt ALLOW_XBT)
    list(APPEND XBT_FILES ${CMAKE_BINARY_DIR}/${dest}/media/Textures.xbt)
    list(APPEND XBT_SOURCE_FILELIST ${skin}/media/Textures.xbt)
  else()
  ...
  foreach(theme ${THEMES})
    if(skin_name STREQUAL "skin.cpm.estuary" AND EXISTS ${skin}/media/${theme}.xbt)
      copy_file_to_buildtree(${skin}/media/${theme}.xbt ALLOW_XBT)
      list(APPEND XBT_FILES ${CMAKE_BINARY_DIR}/${dest}/media/${theme}.xbt)
      list(APPEND XBT_SOURCE_FILELIST ${skin}/media/${theme}.xbt)
    else()
