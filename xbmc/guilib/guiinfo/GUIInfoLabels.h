...
#define PLAYER_PROCESS_VIDEO_DOVI_FRAME_LUMINANCE_MIN (PLAYER_PROCESS + 42)
#define PLAYER_PROCESS_VIDEO_DOVI_FRAME_LUMINANCE_MAX (PLAYER_PROCESS + 43)
#define PLAYER_PROCESS_VIDEO_DOVI_FRAME_LUMINANCE_AVG (PLAYER_PROCESS + 44)

#define PLAYER_PROCESS_VIDEO_HDR_CLL_CLL_MAX (PLAYER_PROCESS + 45)
#define PLAYER_PROCESS_VIDEO_HDR_CLL_FALL_MAX (PLAYER_PROCESS + 46)
#define PLAYER_PROCESS_VIDEO_HDR_MDCV_LUMINANCE_MIN (PLAYER_PROCESS + 47)
#define PLAYER_PROCESS_VIDEO_HDR_MDCV_LUMINANCE_MAX (PLAYER_PROCESS + 48)

#define PLAYER_PROCESS_VIDEO_LIVE_BIT_RATE (PLAYER_PROCESS + 49)
#define PLAYER_PROCESS_VIDEO_LIVE_KIBIT_RATE (PLAYER_PROCESS + 50)
#define PLAYER_PROCESS_VIDEO_LIVE_MIBIT_RATE (PLAYER_PROCESS + 51)
#define PLAYER_PROCESS_VIDEO_QUEUE_LEVEL (PLAYER_PROCESS + 52)
#define PLAYER_PROCESS_VIDEO_QUEUE_DATA_LEVEL (PLAYER_PROCESS + 53)

#define PLAYER_PROCESS_AML_PIXELFORMAT (PLAYER_PROCESS + 60)
#define PLAYER_PROCESS_AML_DISPLAYMODE (PLAYER_PROCESS + 61)
#define PLAYER_PROCESS_AML_EOFT_GAMUT (PLAYER_PROCESS + 62)
#define PLAYER_PROCESS_AML_VS10_MODE (PLAYER_PROCESS + 63)
#define PLAYER_PROCESS_AML_VS10_MODE_RAW (PLAYER_PROCESS + 64)
#define PLAYER_PROCESS_AML_VIDEO_FPS_INFO (PLAYER_PROCESS + 65)
#define PLAYER_PROCESS_AML_VIDEO_FPS_DROP (PLAYER_PROCESS + 66)
