...
constexpr uint32_t PLAYER_PROCESS_AUDIO_OBJECT_DESCRIPTION = PLAYER_PROCESS_START + 58;
constexpr uint32_t PLAYER_PROCESS_AUDIO_DIALNORM = PLAYER_PROCESS_START + 59;
