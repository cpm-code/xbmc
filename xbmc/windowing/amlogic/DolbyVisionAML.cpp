...
void dv_type_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/) {
  list.clear();
  if (aml_display_support_dv_std()) list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50023), static_cast<int>(DV_TYPE::DISPLAY_LED));
  if (aml_display_support_dv_ll()) list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50024), static_cast<int>(DV_TYPE::PLAYER_LED_LLDV));
  if (aml_display_support_hdr_pq()) list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50025), static_cast<int>(DV_TYPE::PLAYER_LED_HDR));
  list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50026), static_cast<int>(DV_TYPE::VS10_ONLY));
}
...
void add_vs10_bypass(std::vector<IntegerSettingOption>& list) {list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50063), DOLBY_VISION_OUTPUT_MODE_BYPASS);}
void add_vs10_dv_bypass(std::vector<IntegerSettingOption>& list) {list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50063), DOLBY_VISION_OUTPUT_MODE_IPT);}
void add_vs10_sdr(std::vector<IntegerSettingOption>& list) {list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50064), DOLBY_VISION_OUTPUT_MODE_SDR10);}
void add_vs10_hdr10(std::vector<IntegerSettingOption>& list) {list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50065), DOLBY_VISION_OUTPUT_MODE_HDR10);}
void add_vs10_dv(std::vector<IntegerSettingOption>& list) {list.emplace_back(CServiceBroker::GetResourcesComponent().GetLocalizeStrings().Get(50066), DOLBY_VISION_OUTPUT_MODE_IPT);}
