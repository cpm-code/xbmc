                                           ...
                                           unsigned int bitDepth)
{
  ...
  policy.srcHdr = dataCache.GetVideoSourceHdrType();
  policy.srcAltHdr = dataCache.GetVideoSourceAdditionalHdrType();
  policy.srcDvInfo = dataCache.GetVideoSourceDoViStreamInfo();
